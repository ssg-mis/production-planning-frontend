  ...
  const renderContent = () => {
    switch (currentPage) {
      case 'dashboard':
        return <Dashboard />;
      case 'order-dispatch':
        return <OrderDispatchPlanning />;
      case 'oil-indent':
        return <OilIndent />;
      case 'oil-indent-approval':
        return <OilIndentApproval />;
      ...
      case 'oil-receipt':
        return <OilReceipt />;
      case 'packing-raw-material':
        return <PackingRawMaterialIndent />;
      case 'raw-material-issue':
        return <RawMaterialIssue />;
      case 'raw-material-receipt':
        return <RawMaterialReceipt />;
      case 'production-entry':
        return <ProductionEntry />;
      case 'balance-material':
        return <BalanceMaterialReceipt />;
      case 'stock-in':
        return <StockIn />;
      case 'actual-dispatch':
